...
export default function Portfolio() {
  ...
  return (
    <div className="bg-gray-50 text-gray-800 relative">
      ...
      <section
        id="home"
        className="flex flex-col md:flex-row items-center justify-center h-auto md:h-[90vh] px-6 md:px-8 gap-8 md:gap-12 pt-28 md:pt-32"
      >
        {/* Left - Profile Image */}
        <motion.div
          initial={{ opacity: 0, x: -50 }}
        ...
        >
          <Image
            ...
            width={280}
            height={280}
            className="rounded-full shadow-lg border-4 border-blue-200 mx-auto md:mx-0"
          />
        </motion.div>
        ...
        <div className="text-center md:text-left mt-6 md:mt-0">
          ...
          <motion.p
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 0.5, duration: 1 }}
            className="mt-4 text-base md:text-lg max-w-xl mx-auto md:mx-0 leading-relaxed"
          >
            Turning ideas into reality with{" "}
            <span className="font-semibold text-blue-600">Java</span>,{" "}
            <span className="font-semibold text-blue-600">Python</span>, and{" "}
            <span className="font-semibold text-blue-600">SQL</span>. Passionate about problem solving,
            full-stack development, and mentoring.
          </motion.p>
      ...
      {/* ================= About ================= */}
      <section id="about" className="min-h-screen px-6 md:px-12 pt-28 md:pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h1
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <p className="text-base md:text-lg mb-4 leading-relaxed italic font-[cursive]">
            I’m an enthusiastic developer with a background in{" "}
            <span className="font-semibold">Agricultural Engineering (BE)</span> from
            Sri Shakthi Institute of Engineering and Technology, Coimbatore, and
            currently pursuing{" "}
          ...
          <p className="text-base md:text-lg mb-6 leading-relaxed italic font-[cursive]">
            Skilled in <span className="font-semibold">Java, React, OOP, SQL, DSA</span>, I’ve
            built <span className="text-blue-600">MERN applications</span>, console-based projects, and scalable solutions.
          </p>
        </div>
      </section>

      {/* ================= Skills ================= */}
      <section id="skills" className="min-h-screen px-6 md:px-12 pt-28 md:pt-32">
        <div className="max-w-6xl mx-auto">
          <motion.h2
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl font-bold text-black mb-6">My Projects</h1>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 text-center"
                >
                  View Project
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-500 text-center"
                >
                  View Deployment
                </a>
              </div>
      ...
      {/* ================= Contact ================= */}
      <section id="contact" className="min-h-screen px-6 md:px-12 flex flex-col justify-between pt-28 md:pt-32">
        <div>
          <div className="max-w-4xl mx-auto text-center">
            <motion.h1
              initial={{ opacity: 0, y: -30 }}
...
function ContactCard({ icon, text, link }) {
  return (
    ...
    >
      {icon}
      <span className="text-gray-700 break-words">{text}</span>
    </motion.a>
  );
}
